...
const ACADEMIC_CURRICULUM = {
  ...
  7: [
    {
      code: "CSE401",
      name: "CAPSTONE PROJECT DESIGN-I",
      credits: 3,
      obtainedGrade: null,
      components: [
        { type: "Continuous Assessment", maxMarks: 100, weightage: 40, scored: 85 },
        { type: "Practical End Term", maxMarks: 100, weightage: 60, scored: 80 }
      ]
    },
    {
      code: "CSE403",
      ...
      components: [
        { type: "Attendance Marks", maxMarks: 5, weightage: 5, scored: 4 },
        { type: "Continuous Assessment", maxMarks: 100, weightage: 25, scored: 80 },
        { type: "Objective Type End Term", maxMarks: 60, weightage: 70, scored: 42 }
      ]
    },
    {
      code: "CSE411",
      ...
      components: [
        { type: "Attendance Marks", maxMarks: 5, weightage: 5, scored: 4 },
        { type: "Continuous Assessment", maxMarks: 100, weightage: 45, scored: 82 },
        { type: "Practical End Term", maxMarks: 100, weightage: 50, scored: 78 }
      ]
    },
    {
      code: "CSE415",
      ...
      components: [
        { type: "Attendance Marks", maxMarks: 5, weightage: 5, scored: 5 },
        { type: "Continuous Assessment", maxMarks: 100, weightage: 25, scored: 88 },
        { type: "Theory End Term", maxMarks: 40, weightage: 70, scored: 28 }
      ]
    },
    {
      code: "PES412",
      ...
      components: [
        ...
        { type: "Practical End Term", maxMarks: 100, weightage: 55, scored: 78 }
      ]
    }
  ],
  8: [
    {
      code: "CSE402",
      name: "CAPSTONE PROJECT DESIGN-II",
      credits: 4,
      obtainedGrade: null,
      components: [
        { type: "Continuous Assessment", maxMarks: 100, weightage: 30, scored: 90 },
        { type: "Practical End Term", maxMarks: 100, weightage: 70, scored: 85 }
      ]
    },
    {
      code: "CSE404",
      name: "INDUSTRY INTERNSHIP TRAINING",
      credits: 6,
      obtainedGrade: null,
      components: [
        { type: "Continuous Assessment", maxMarks: 100, weightage: 50, scored: 92 },
        { type: "Practical End Term", maxMarks: 100, weightage: 50, scored: 88 }
      ]
    },
    {
      ...
      components: [
        { type: "Attendance Marks", maxMarks: 5, weightage: 5, scored: 4 },
        { type: "Continuous Assessment", maxMarks: 100, weightage: 45, scored: 80 },
        { type: "Practical End Term", maxMarks: 100, weightage: 50, scored: 76 }
      ]
    }
  ]
};
